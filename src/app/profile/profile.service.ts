...
export class ProfileService {
  ...
  resumeurl = 'assets/images/vinod_resume.pdf';
  ...
  educationData: any = [
    ...
    },
    {
      ...
      stream: 'Science and Mathematics',
      institution: 'VIVEKANANDA VIDYA NIKETAN,MANDASA',
...
Completed my Secondary school with 70%.`,
  ...
  exprienceData: any = [
    {
      id: 2,
      company: 'LearnigMate solutions PVT LTD',
      location: 'Mumbai',
